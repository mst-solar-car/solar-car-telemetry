...
(function(){
    ...
    ko.utils = (function () {
        ...
        return {
            ...
            iteratorToArray: function (value) {
                var resultArr = value;

                try {
                    if (typeof value == "object" && value.next && typeof value.next == "function" && !Array.isArray(value)) {
                        // Value is a generator/iterator, turn it into an array
                        resultArr = [];
                    ...
                    // Older browser or something else went wrong
                    resultArr = value;
                }
    ...
    ko.exportSymbol('utils.iteratorToArray', ko.utils.iteratorToArray);
