 ...
 * In that folder you should have a "Registration.ts" file that will contain an implementation of 
...
export = modules.map((moduleName) => { return "modules/" + moduleName + "/Registration"; });